...
<body>
    ...
    <div>
        <asp:MultiView ID="CBF110002_MV1" ActiveViewIndex="0" runat="server">
        <asp:View ID="CBF110002_View1" runat="server">
            <asp:GridView ID="CBF110002_GV1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource2" EmptyDataText="沒有資料錄可顯示。" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" OnRowDeleted="Page_Load" OnSelectedIndexChanged="Page_Load">
            ...
            <br />
            請點選單字來查閱中文解釋<br />
            <asp:DropDownList ID="CBF110002_DDL1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="word" DataValueField="ch_explanation" OnSelectedIndexChanged="CBF110002_DDL1_SelectedIndexChanged">
            </asp:DropDownList>
            <asp:Button ID="CBF110002_PreviousButton" runat="server" Text="PreviousButton" Enabled="False" OnClick="CBF110002_PreviousButton_Click" />
            <asp:Button ID="CBF110002_NextButton" runat="server" Text="NextButton" OnClick="CBF110002_NextButton_Click" />
            <asp:Button ID="CBF110002_testBtn" runat="server" Text="測驗去" OnClick="CBF110002_testBtn_Click" />    
            ...
            <br />
            <asp:Literal ID="CBF110002_cambridge" runat="server"></asp:Literal>
            <br />
            <br />
        ...
        <asp:View ID="CBF110002_View2" runat="server">        
            <asp:Literal ID="CBF110002_ch_hint" runat="server"></asp:Literal>
            <asp:TextBox ID="CBF110002_input" runat="server" onclick="this.setSelectionRange(0,999)" onfocus="this.setSelectionRange(0,999)" AutoComplete="off"></asp:TextBox>
            <asp:Button ID="CBF110002_nextQBtn" runat="server" Text="下一題" OnClick="CBF110002_nextQBtn_Click" />
            <br />
            請輸入完整單字(底線是用來提示有幾個字元, 如果消失了可以移動滑鼠至方格上來查看.)
            <br />
            <a href="SimpleWordTest_comb_t.aspx" runat="server" id="reed" style="display:none">重玩</a>
        </asp:View>        
    </asp:MultiView>
    </div>
    </form>
